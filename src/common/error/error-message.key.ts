export const errors = {
  ...
  block: {
    update: 'errors.messages.block.update',
    update_start_block: 'errors.messages.block.update_start_block',
    remove: 'errors.messages.block.remove',
    field: {
      next_block_id: 'errors.messages.block.field.next_block_id',
    },
    attribute: {
      bad_request: 'errors.messages.block.attribute.bad_request',
    },
  },
};
